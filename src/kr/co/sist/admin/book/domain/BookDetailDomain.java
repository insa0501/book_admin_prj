...
public class BookDetailDomain {
	private String book_isbn, book_name, book_country, book_type_no, book_writer, book_company, book_date,
			book_input_date, book_info, book_best, book_activity, book_img;
	private int book_price, book_stock;
	public BookDetailDomain() {
	}
	public BookDetailDomain(String book_isbn, String book_name, String book_country, String book_type_no,
			String book_writer, String book_company, String book_date, String book_input_date, String book_info,
			String book_best, String book_activity, String book_img, int book_price, int book_stock) {
		super();
